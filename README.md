...
Freelance developer who likes to build cross-platform apps for iOS, Android and the Web. Mostly likes to manage these apps in the cloud by GCP or AWS or Azure tooling. Acts as full-stack/frontend/backend JavaScript, Node, PHP, .NET, Go, Dart or Flutter developer... :rocket:
...
💬 Ask me about; JavaScript, Node, PHP, .NET, Go, Dart or Flutter   
